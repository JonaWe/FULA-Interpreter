...
public enum TokenType {
    ...
    NOT, EQUALS, AND, OR, XOR,SMALLER, GREATER, BOOLEAN,
    LCURLYBRACKET, RCURLYBRACKET, COMMA, COLON,
    LET, IN, WHERE, END, IF, THEN, ELSE, ID, PRINT, INPUT,
    SIN, COS, TAN, LOG, EXP, SEMICOLON, LSQUAREBRACKET, RSQUAREBRACKET,
    ADD, MAP, FILTER, STRING, ISTYPE, BOOLTYPE, STRINGTYPE, FLOATTYPE
}